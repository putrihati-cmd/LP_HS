      ...
      <main>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <aside className="hidden md:block w-1/4 flex-shrink-0">
              ...
              <div className="mt-6 bg-gray-100 p-4 rounded text-center">
                ...
                <p className="text-sm text-gray-600">Call us at 0812-3456-7890</p>
              </div>
            </aside>
        ...
        <section className="py-16 bg-white border-t border-gray-100">
          <div className="container mx-auto px-4 text-center max-w-5xl">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-6 uppercase">The Best Place to Design & Print</h3>
            <p className="text-gray-500 leading-relaxed text-sm text-justify md:text-center">
              HS Copy Center digital printing dan percetakan dengan tagline Sang Pencetak Sukses Anda, memiliki cabang yang tersebar di Indonesia. 
              Berbagai kebutuhan printing, jasa desain grafis, percetakan, fotocopy hingga coworking space bisa dilayani di tempat print kami. 
              Mulai dari brosur, poster dengan berbagai jenis dan ukuran, cetak foto, ID Card, stempel, kop surat, nota, spanduk, banner, 
              X banner, roll banner, buku yasin, photobook, buku agenda, kartu nama, kalender baik meja atau dinding, mug secara custom, 
              berbagai macam botol minum termasuk tumbler starbuck, hingga plakat. HS Copy Center juga bisa print custom interior dan eksterior, 
              seperti wallpaper dinding custom, neon box, neon flex dengan berbagai pilihan harga. Selain itu, kami pun bisa melayani print kain 
              atau textile, pouch, totebag, bantal, kerudung, kerudung segi empat dan jilbab terbaru dalam berbagai model. Saat ini kami sudah 
              menyediakan Jasa Print 3D. HS Copy Center memang the best place to design & print.
            </p>
          </div>
        </section>
      </main>
