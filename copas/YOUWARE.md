# HS Copy Center Website

Website kloning dari snapy.co.id dengan tema warna berbeda.

## Tema Warna
- **Primary Color**: Teal (#00a8a8) - berbeda dari Snapy yang menggunakan orange
- **Secondary Color**: Gold (#ffaf00)
- **Font**: Poppins

## Struktur Website
1. Header - Logo HS Copy Center, search bar, navigasi
2. Hero Slider - Banner cetak custom berkualitas
3. Feature Bar - Kualitas Premium, Pengiriman Cepat, Layanan Terbaik, Support 24/7
4. Produk Populer - Sidebar kategori + grid produk
5. Produk Terbaru - Grid 4 kolom
6. About Section - Tentang HS Copy Center
7. Artikel Terbaru - 4 artikel dengan background gray
8. Footer - Links, outlet info, support, social media
