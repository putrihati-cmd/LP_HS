...
const API_URL = import.meta.env.VITE_API_URL || 'https://hscopycenter-backend.tholibadilmaruf-campus.workers.dev/api';
...
export function AIContentGenerator() {
  ...
  const saveArticle = async () => {
    if (!result || activeTab !== 'blog') return;
    ...
    try {
      ...
      alert('Gagal menyimpan artikel. Cek koneksi internet.');
    } finally {
      setSaving(false);
    }
  };
